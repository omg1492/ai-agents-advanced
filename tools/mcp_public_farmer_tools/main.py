...
# Initialize OpenTelemetry tracing BEFORE importing FastMCP
...
if otel_enabled:
    try:
        ...
        service_name = os.getenv("OTEL_SERVICE_NAME", "mcp-public-farmer-tools")
...
def build_server() -> tuple[FastMCP, object]:
    ...
    if otel_enabled:
        ...
        class BusinessDimensionsMiddleware(BaseHTTPMiddleware):
            ...
            async def dispatch(self, request: Request, call_next):
                ...
                is_vip = False
                agent_type = "mcp-public-farmer-tools"
    ...
    # This must be last as it's ASGI-style wrapping
